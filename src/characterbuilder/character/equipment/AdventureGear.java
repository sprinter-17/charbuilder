...
public enum AdventureGear implements Equipment {
    ...
    private AdventureGear(EquipmentCategory category, Value value, Weight weight) {
        this(category, value, weight, 1);
    }

    private AdventureGear(EquipmentCategory category, Value value, Weight weight, int perCount) {
        this(category, value, weight, perCount, null);
    }

    private AdventureGear(EquipmentCategory category, Value value, Weight weight, String name) {
