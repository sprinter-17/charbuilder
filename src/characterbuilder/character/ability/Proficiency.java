...
public enum Proficiency implements Attribute {
    ...
    ALL_MELEE_WEAPONS(WEAPON_PROFICIENCY, ALL_WEAPONS),
    ALL_SIMPLE_MELEE(WEAPON_PROFICIENCY, ALL_MELEE_WEAPONS),
    ALL_MARTIAL_MELEE(WEAPON_PROFICIENCY, ALL_MELEE_WEAPONS),
    ALL_RANGED_WEAPONS(WEAPON_PROFICIENCY, ALL_WEAPONS),
    ALL_SIMPLE_RANGED(WEAPON_PROFICIENCY, ALL_RANGED_WEAPONS),
    ALL_MARTIAL_RANGED(WEAPON_PROFICIENCY, ALL_RANGED_WEAPONS),
    //
