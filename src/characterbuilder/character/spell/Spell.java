...
public enum Spell implements Option {
    ...
    ARCANE_EYE(MagicSchool.DIVINATION, 4, "1 action", "30 feet", "-",
        "V, S, M ", "up to 1 hour",
        "Create an invisible, magical eye that provides mental visual information in all directions. "
        + "As an action, move the eye up to 30 feet in any direction including passing through "
        + "an opening as small as 1 inch in diameter."),
    BANISHMENT(MagicSchool.ABJURATION, 4, "1 action", "60 feet", "1 creature",
        "V, S, M ", "up to 1 minute",
        "Banish a creature to another plane of existence. Chr. save. \n"
        + "+1 creature per extra spell level."),
    BLACK_TENTACLES(MagicSchool.CONJURATION, 4, "1 action", "90 feet", "20-foot square",
        "V, S, M ", "up to 1 minute",
        "Area becomes difficult terrain. Creature in affected area takes 3d6 bludgeoning damage "
        + "and is restrained. Dex. save. Break free using Str. or Dex. check."),
    BLIGHT(MagicSchool.NECROMANCY, 4, "1 action", "30 feet", "1 creature",
        "V, S", "Instantaneous",
        "8d8 necrotic damage. Con. save for half. No effect on undead or constructs. "
        + "Maximum damage against plants. +1d8 damage per extra level."),
    COMPULSION(MagicSchool.ENCHANTMENT, 4, "1 action", "30 feet", "Visible creatures in range",
        "V, S", "up to 1 minute",
        "Cause compulsion. Wis. save. As a bonus action, effected creatures must move in a "
        + "designated direction and then make another save."),
    CONFUSION(MagicSchool.ENCHANTMENT, 4, "1 action", "90 feet", "10-foot-radius",
        "V, S, M ", "up to 1 minute",
        "Causes confusion on all creatures in area. Wis. save. each turn"
        + "Affected creatures cannot take reactions. Each turn roll d10:<br>"
        + "1: move in random direction.<br>"
        + "2-6: no move or action.</br>"
        + "7-8: melee attack on random creature within reach.<br>"
        + "9-10: move and act normally.<br>"
        + "+5-foot-radius area per extra spell level."),
    CONJURE_MINOR_ELEMENTALS(MagicSchool.CONJURATION, 4, "1 minute", "90 feet", "Unoccupied spaces",
        "V, S", "up to 1 hour",
        "Summon elemental: 1 CR 2, 2 CR 1, 4 CR 1/2 or 8 CR 1/4.<br> "
        + "x2 creatures at 6th level, x3 creatures at 8th level."),
    CONJURE_WOODLAND_BEINGS(MagicSchool.CONJURATION, 4, "1 action", "60 feet", "Unoccupied spaces",
        "V, S, M ", "up to 1 hour",
        "Summon fey creatures: 1 CR 2, 2 CR 1, 4 CR 1/2 or 8 CR 1/4.<br>"
        + "x2 creatures at 6th level, x3 creatures at 8th level."),
    CONTROL_WATER(MagicSchool.TRANSMUTATION, 4, "1 action", "300 feet", "cube of water up to 100-feet",
        "V, S, M ", "up to 10 minutes",
        "As an action each turn, cause the water to:<br>"
        + "Rise 20 feet, causing a flood or wave.<br>"
        + "Part the water to create a trench.<br>"
        + "Cause the water to flow in a new direction, including over obstacles.<br>"
        + "Create a whirlpool vortex 25 feet deep and 50 feet wide. 2d8 bludgeoning damage. "
        + "Str. save for half."),
