...
public enum Weapon implements Equipment {
	...
	DAGGER(SIMPLE_MELEE, cp(200), lb(1), attack("5", "1d4", PIERCING, Weapon::finessed), attack("20/60", "1d4",
			PIERCING, Weapon::ranged, "Thrown")),
	...
	QUARTERSTAFF(SIMPLE_MELEE, cp(20), lb(4), attack("5", "1d6", BLUDGEONING, Weapon::melee, "1H"), attack("5", "1d8",
			BLUDGEONING, Weapon::melee, "2H")),
	SICKLE(SIMPLE_MELEE, cp(100), lb(2), attack("5", "1d4", SLASHING, Weapon::melee)),
	SPEAR(SIMPLE_MELEE, cp(100), lb(3), attack("20/60", "1d6", PIERCING, Weapon::melee), attack("5", "1d8", PIERCING,
			Weapon::melee, "2H")),
	BATTLEAXE(MARTIAL_MELEE, cp(1000), lb(4), attack("5", "1d8", SLASHING, Weapon::melee, "1H"), attack("5", "1d10",
			SLASHING, Weapon::melee, "2H")),
	...
	LONGSWORD(MARTIAL_MELEE, cp(1500), lb(3), attack("5", "1d8", SLASHING, Weapon::melee, "1H"), attack("5", "1d10",
			SLASHING, Weapon::melee, "2H")),
	...
	WARHAMMER(MARTIAL_MELEE, cp(1500), lb(2), attack("5", "1d8", BLUDGEONING, Weapon::melee, "1H"), attack("5", "1d10",
			BLUDGEONING, Weapon::melee, "2H")),
