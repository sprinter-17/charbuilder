...
public class SpellCastingTest {
	...
	public void testCannotAddCantripToSpellCasting() {
		assertThrows(IllegalArgumentException.class, () -> casting.addPreparedSpell(Spell.MAGE_HAND));
	}
	...
	public void testCannotLearnSpellTwice() {
		casting.addPreparedSpell(Spell.AID);
		assertThrows(IllegalArgumentException.class, () -> casting.addPreparedSpell(Spell.AID));
	}
